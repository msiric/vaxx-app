...
You can access the application here: [Demo](https://vaxx-app-demo.pages.dev/) (You can use the test account for a quick peek - username: **testuser**, password: **testpassword**)
